...
/***/ function(module, exports, __webpack_require__) {
	...
	var TargetArea = __webpack_require__(164);
	var FlowArea = __webpack_require__(165);
	var NewMsgArea = __webpack_require__(167);
	...
	var ChatApp = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'div',
	      { className: 'chatMain' },
	      React.createElement(TargetArea, null),
	      React.createElement(FlowArea, null),
	      React.createElement(NewMsgArea, null)
	    );
	  }
	});

	ReactDom.render(React.createElement(ChatApp, null), container);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".chatMain {\n  width: 300px;\n  height: 504px;\n  background: greenyellow;\n  border: 1px solid #000;\n  margin-left: 10px; }\n\n.targetArea {\n  height: 50.4px;\n  background: blueviolet; }\n  .targetArea .avatar {\n    width: 40.32px;\n    margin-top: 5.04px;\n    margin-left: 5.04px; }\n  .targetArea .profile {\n    display: inline-block; }\n\n.flowArea {\n  height: 403.2px;\n  background: darkcyan;\n  overflow: auto; }\n  .flowArea p {\n    margin-top: 8.064px;\n    margin-left: 6px;\n    margin-right: 6px;\n    height: 1.4em;\n    line-height: 1.4em;\n    padding: 0 6px;\n    border-radius: 6px;\n    clear: both; }\n\n.hasSend {\n  background: deepskyblue;\n  float: right; }\n\n.hasReceive {\n  background: snow;\n  float: left; }\n\n.newMsgArea {\n  height: 50.4px;\n  background: lightcoral; }\n\n.editIpt {\n  border: none;\n  outline: none;\n  width: 240px;\n  height: 30.24px;\n  margin-top: 10.08px;\n  margin-left: 5.04px; }\n\n/*# sourceMappingURL=main.css.map */\n", ""]);
	...
	var MsgList = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      'div',
	      null,
	      this.props.flows.map(createList)
	    );
	  }
	});
	...
	module.exports = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'div',
	      { className: 'flowArea' },
	      React.createElement(MsgList, { flows: this.state.flows })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'div',
	      { className: 'newMsgArea' },
	      React.createElement(
	        'form',
	        { onSubmit: this.sendMsg },
	        React.createElement('input', { type: 'text', className: 'editIpt', onChange: this.onChange, value: this.state.newMsg }),
	        React.createElement(
	          'button',
	          { className: 'sendBtn' },
	          '送出'
